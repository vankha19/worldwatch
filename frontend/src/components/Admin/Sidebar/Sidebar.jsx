...
const Sidebar = ({ activeTab, setToggleSidebar }) => {
    ...
    return (
        <aside className="sidebar z-10 sm:z-0 block min-h-screen fixed left-0 pb-14 max-h-screen w-3/4 sm:w-[13%] bg-gray-800 text-white overflow-x-hidden border-r">
