            ...
            >
                <div className="flex flex-col gap-3 m-2 sm:w-1/2">
                    ...
                    <div className="flex justify-between">
                        ...
                        >
                            <MenuItem value="Inox">Inox không gỉ</MenuItem>
                            <MenuItem value="Leather">Da</MenuItem>
                        </TextField>
                    </div>
                    <div className="flex justify-between">
                        <TextField
                    ...
                    <div className="flex justify-between gap-4 items-start">
                        ...
                        <label className="rounded font-medium bg-blue-400 text-center cursor-pointer text-white py-2 px-2.5 shadow hover:shadow-lg">
                            <input
                                type="file"
                                name="logo"
                                accept="image/*"
